    ...
    public class Startup
    {
        ...
        private static void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Desafio Fullstack - Votador",
                    Description = "Votação de itens a serem implantados",
                    Contact = new OpenApiContact
                    {
                        Name = "Adriano Jose Ament",
                        Email = "adrianojament@gmail.com",
                        Url = new Uri("https://github.com/adrianojament/votador")
                    },
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Votador.apllication v1"));
            }
